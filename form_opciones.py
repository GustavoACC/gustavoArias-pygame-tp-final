...
class FormOptionMenu(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.boton_volver = Button(master=self,x=446,y=335,w=140,h=100,image_background="UI_Flat_Frame_01_Horizontal.png", on_click=self.on_click_volver, on_click_param=None, text="Volver", font="fonts/Minecraft.ttf", font_size=30, font_color=C_WHITE)
