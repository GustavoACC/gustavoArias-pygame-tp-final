...
class FormMainMenu(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active, sub_active):
        ...
        self.active = active
        self.inicio = False
        self.boton_opciones = Button(master=self,x=446,y=205,w=170,h=50,image_background=PATH_GUI+"UI_Flat_Frame_01_Horizontal.png", on_click=self.on_click_active_form, on_click_param="options_menu", text="Opciones", font="fonts/Minecraft.ttf", font_size=30, font_color=C_WHITE)
        self.boton_seleccion_nivel = Button(master=self,x=446,y=280,w=170,h=50,image_background=PATH_GUI+"UI_Flat_Frame_01_Horizontal.png", on_click=self.on_click_active_form, on_click_param="selector_nivel", text="Niveles", font="fonts/Minecraft.ttf", font_size=30, font_color=C_WHITE)
        self.boton_salir = Button(master=self,x=446,y=350,w=170,h=50,image_background=PATH_GUI+"UI_Flat_Frame_01_Horizontal.png", on_click=self.on_click_salir, on_click_param="", text="Salir", font="fonts/Minecraft.ttf", font_size=30, font_color=C_WHITE)
